...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?= base_url('assets/') ?>/images/icon/unuja.png">
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="<?= base_url('assets/') ?>/images/icon/unuja.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="<?= base_url('') ?>" aria-expanded="true"><i class="ti-dashboard"></i><span>Beranda</span></a>
                            </li>
                            <?php
                            ...
                            <li>
                                <a href="<?= base_url('tahunajaran') ?>" aria-expanded="true"><i class="fa fa-calendar"></i><span>Tahun Ajaran</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?= $this->session->userdata('nama_lengkap') ?> <i class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Message</a>
                                <a class="dropdown-item" href="<?= base_url('users') ?>">Settings</a>
