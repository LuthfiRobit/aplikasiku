            ...
            <div class="login-box ptb--100">
                ...
                <div class="login-form-body">
                    <div class="form-gp">
                        ...
                        <?php echo form_input("username", '', array('class' => 'form-control', 'id' => 'exampleInputEmail1')); ?>
                        <i class="ti-user"></i>
                    </div>
                    <div class="form-gp">
                        <label for="exampleInputPassword1">Password</label>
                        <?php echo form_password("password", '', array('class' => 'form-control', 'id' => 'exampleInputPassword1')); ?>
                        <i class="ti-lock"></i>
                    </div>
